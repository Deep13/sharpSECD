...
const ControlSalesRIGZO = () => {
  ...
  return (
    <div>
      <Head>
        <title>Control Sales R-IGZO - Sharp</title>
        <meta
          name="description"
            ...
            <div style={{ width: "70%" }}>
              ...
              >
                ...
                <Row className="mb-3">
                  {/* Mobile */}
                  <Col xs={2}>
                    <Form.Group controlId="formMobileCode">
                      <Form.Control
                        type="text"
                        placeholder="+1"
                        name="mobileCode"
                ...
                <p style={{ color: "white" }}>
                  ...
                  <a
                    ...
                    style={{ color: "#e61d24" }}
                    onClick={(event) =>
                      callFunct(event, "/memory-in-pixel-lcds-product")
                    }
                  >
                    {" "}
...
export default ControlSalesRIGZO;
