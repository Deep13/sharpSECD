...
export default function RIGZOTCS() {
        ...
        >
          ...
          >
            ...
            <div className="col-md-6" style={{ padding: "0px 100px" }}>
              <div>
                <Image
                  src={image1} // Can be a local import or external URL
                  alt="Sharp MIP"
                  style={{ width: "100%" }}
                  width={500} // specify a width
                  height={300} // specify a height
                  sizes="100vw" // optional: responsive sizing
      ...
      >
              ...
              <div tabIndex={-1} style={{ height: "100%", padding: 10 }}>
                ...
                >
                  ...
                  <p>
                    ...
                    circuit thinning, thanks to its high electron mobility rate.
          ...
          <div className="row">
            ...
            <div tabIndex={0} className="col-md-4">
              <div>
                ...
                <p style={{ padding: "1vw" }}>
                  IGZO's electron mobility is far higher than Amorphous Silicon
                  (a-Si) displays.
                </p>
              </div>
            </div>
            <div tabIndex={0} className="col-md-4">
              <div>
                ...
                <p style={{ padding: "1vw" }}>
                  IGZO enables higher resolution at the same or lower power than
                  a-SI solutions.
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div style={{ width: "70%" }}>
              <Form noValidate className="TCS-R-IGZO" onSubmit={handleSubmit}>
                {/* Email */}
                <Row className="mb-2">
                  <Col>
                    <Form.Control
                ...
                <p style={{ color: "white" }}>
                  ...
                  <a
                    ...
                    onClick={(event) => {
                      event.preventDefault();
                      window.location.href = "/memory-in-pixel-lcds-product";
                    }}
                  >
                    {" "}
