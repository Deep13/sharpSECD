...
export default class ODonnellMIP extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: null,
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <strong>Creating top product solutions with O'Donnell Associates North</strong>
          </p>
        </div>
        <div
          style={{
                ...
                <div tabIndex={0} className="col-md-6">
                  <div tabIndex={-1} style={{ height: "100%", padding: 10 }}>
                    ...
                    >
                      ...
                      <div>
                        <img style={{ width: "80%" }} src={ODonnell} role="presentation" alt="ODonnell" />
                      </div>
                      <p>+</p>
                      <div>
          ...
          >
            ...
            >
              ...
              <div className="col-md-6">
                <div className="padding-top-50 d-none d-md-block"></div>
                <div className="padding-top-50"></div>
                <Form1 noValidate className="O_Donnell" onSubmit={this.onSubmit}>
