    ...
    return (
      <div>
        ...
        <div className="row" style={{ width: "100%", margin: 0 }}>
          <div id="main-content" role="main" tabIndex={0} style={{ padding: 0, backgroundImage: `url(${redback})`, width: "100%", textAlign: "center", backgroundPosition: "center" }}>
            <img className="mob-width-300" src={SHARPLogo} role="presentation" alt="Control Sales Logo" />
          </div>
          <img className="hide-on-mobile" src={cycle} style={{ width: "100%" }} role="presentation" alt="Control Sales Logo" />

          <div className="signage-section" tabIndex={0} style={{ backgroundImage: `url(${redback})`, width: "100%", textAlign: "center", backgroundPosition: "center" }}>
            <img className="show-on-mobile" src={ePosterMobile} style={{ width: "100%" }} role="presentation" alt="Control Sales Logo" />
            <h1 style={{ color: "white", fontWeight: "bold" }}>
              Say Goodbye to Paper <br />
              Signage.{" "}
            </h1>
            <img role="presentation" alt="arrow" src={arrow} style={{ maxWidth: "50px", paddingTop: 30 }} />
          </div>
          <div className="meet-section" tabIndex={0} style={{ width: "100%", textAlign: "center", backgroundPosition: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
            <h2>
              <strong>
            ...
            <p style={{ maxWidth: 1120, marginTop: 20 }}>
              Paper A2 posters are now a thing of the past. The future of lowpower digital signage displays is here. Sharp and E-Ink bring you the world's first electronic A2 poster solution.
            </p>
          </div>
          <div className="biker-section" tabIndex={0} style={{ width: "100%", textAlign: "left", backgroundPosition: "top" }}>
            <img className="show-on-mobile" src={mountain_mobile} style={{ width: "100%" }} role="presentation" alt="Control Sales Logo" />
            <h2>
          ...
          <div className="row" tabIndex={0} style={{ padding: 0, background: "#c6c7d4", width: "100%", textAlign: "left", backgroundPosition: "top", padding: "80px 50px", marginLeft: 0 }}>
            <div className="col-lg-4" style={{ padding: "20px 20px" }}>
              <img src={Escalator} style={{ height: "100%", width: "100%" }} role="presentation" alt="Control Sales Logo" />
            </div>
            <div className="col-lg-4" style={{ padding: "20px 20px" }}>
              <img src={Travel} style={{ height: "100%", width: "100%" }} role="presentation" alt="Control Sales Logo" />
            </div>
            <div className="col-lg-4" style={{ padding: "20px 20px" }}>
              <img src={Airport} style={{ height: "100%", width: "100%" }} role="presentation" alt="Control Sales Logo" />
            </div>
          </div>
          <div className="green-section" tabIndex={0} style={{ width: "100%", textAlign: "center", backgroundPosition: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
            <h2>
              <strong>
            ...
            <div className="row" tabIndex={0} style={{ width: "100%", textAlign: "left", marginTop: 30, paddingBottom: 20 }}>
              <div className="col-lg-4" style={{ textAlign: "center" }}>
                <img src={Zero} style={{ width: 200 }} role="presentation" alt="Control Sales Logo" />
              ...
              <div className="col-lg-4" style={{ textAlign: "center" }}>
                <img src={Earth} style={{ width: 200 }} role="presentation" alt="Control Sales Logo" />
              ...
              <div className="col-lg-4" style={{ textAlign: "center" }}>
                <img src={Low} style={{ width: 200 }} role="presentation" alt="Control Sales Logo" />
          ...
          <div className="row key-section" tabIndex={0} style={{ background: "#c6c7d4", width: "100%", textAlign: "left", backgroundPosition: "top", marginLeft: 0 }}>
            <div className="col-lg-6" style={{ padding: "20px 20px", paddingRight: 50 }}>
              <h2 style={{ color: "black" }}>
                <strong>Key Features</strong>
              </h2>
              <ul style={{ color: "black" }}>
                <li>Sharp's IGZO technology enables a narrow panel frame and improved design for multi-panel display. </li>
                <li>E Ink's latest e-paper module, "Spectra6," offers an expanded color gamut for vivid display quality. </li>
                <li>A thin and lightweight product enables easy hanging/installation. </li>
              </ul>
            </div>
            <div className="col-lg-6" style={{ padding: "20px 20px" }}>
              <img src={eposter} style={{ width: "100%" }} role="presentation" alt="Control Sales Logo" />
            ...
            >
              <div style={{ width: "70%" }}>
                ...
                <div className="hide-on-mobile">
                  ...
                  >
                    <strong>LET'S TALK ABOUT ZERO-POWER DISPLAYS FOR YOUR NEXT SIGNAGE PRODUCT DESIGN</strong>
                  </h1>
                  <p
                    style={{
                      color: "white",
                ...
                <div className="show-on-mobile">
                  ...
                  >
                    Please drop us a line. A member of the Sharp team will get in touch with you ASAP to talk about the ePoster as a perfect fit for your next design.
                  </p>
                </div>
              </div>
              <div className="contact-resp">
                <Form1 noValidate className="ePoster" onSubmit={this.onSubmit}>
                  ...
                  <Button className="blueButton" aria-label="Submit Form Button" style={{ marginTop: 10, width: "100%" }} variant="primary" type="submit" disabled={this.state.submit}>
                    Submit
                  </Button>
