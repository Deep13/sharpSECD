    ...
    return (
      <div>
        <Helmet>
          ...
          <meta name="description" content="Discover Sharp's ultra-low power Memory-in-Pixel LCDs with high ambient-light performance and 64-color options—ideal for wearables, meters & more." />
        </Helmet>
