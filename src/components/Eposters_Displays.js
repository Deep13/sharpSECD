                    ...
                    >
                        <div className="col-lg-6" style={{ padding: 80 }}>
                            ...
                            <Button
                                ...
                                style={{ backgroundColor: "rgb(237, 12, 12)", borderColor: "rgb(237, 12, 12)", color: "white", marginTop: 40, borderRadius: 0, fontSize: 20, width: '100%', maxWidth: 320 }}
                            >
                                Contact Sharp
                            </Button>
                        </div>
